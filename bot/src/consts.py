...
db_notify_path="/project/databases/notifications.db"
db_token_path="/project/databases/tokens.db"
...
try:
	...
	print("Error\nNo AUTH_LINK was found, create a .env file and put a variable called AUTH_LINK in it")
	exit(1)

try:
	redirect_link = os.environ['REDIRECT_LINK']
except:
	print("Error\nNo REDIRECT_LINK was found, create a .env file and put a variable called REDIRECT_LINK in it")
	exit(1)
...
try:
	con = sqlite3.connect(db_token_path)
	cur = con.cursor()
...
try:
	con = sqlite3.connect(db_notify_path)
	cur = con.cursor()
